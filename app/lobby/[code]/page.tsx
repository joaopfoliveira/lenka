...
function SafeExitButton({
  ...
  onClick: () => void;
  label: string;
  hotkeyProps?: React.ButtonHTMLAttributes<HTMLButtonElement>;
}) {
  return (
    <button
      onClick={onClick}
          ...
          <div className="flyer-box bg-card p-10 text-center">
            {error ? (
              <div className="space-y-4">
                ...
                >
                  {withShortcut(t('Return Home', 'Voltar ao início'), `(${ESC_LABEL})`)}
                </button>
              </div>
            ) : (
            ...
            <div className="flex flex-col items-center gap-3">
              ...
              <div className="mt-6 flex justify-center">
                ...
                >
                  ...
                  {withShortcut(t('Exit to Home', 'Sair para o início'), `(${ESC_LABEL})`)}
                </button>
              </div>
            </div>
          </div>
                ...
                <div className="space-y-2">
                  {!isReady ? (
                    <button
                      ...
                      {...hotkey('enter', { title: t(`Shortcut: ${ENTER_SYMBOL}`, `Atalho: ${ENTER_SYMBOL}`) })}
                    >
                      {withShortcut(
          ...
          <div className="space-y-6">
            <div className="flyer-box bg-card p-6">
              <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                ...
                >
                  <DoorOpen className="h-4 w-4" />
                  {withShortcut(isLeaving ? t('Leaving...', 'A sair...') : t('Leave Game', 'Sair do jogo'), `(${ESC_LABEL})`)}
                </button>
              </div>
            ...
            <div className="flyer-box bg-card p-3 space-y-2.5 mt-12">
              ...
              <div className="flex items-stretch gap-2">
                ...
                <button
                  ...
                  {...hotkey('enter', { allowInput: true, title: t(`Shortcut: ${ENTER_SYMBOL}`, `Atalho: ${ENTER_SYMBOL}`) })}
                >
                  {withShortcut(hasSubmitted ? t('Update', 'Atualizar') : t('Submit', 'Submeter'), `(${ENTER_SYMBOL})`)}
                </button>
              </div>
          ...
          <StageBackground disableMotion={disableHeavyEffects} maxWidth="max-w-md" overlay={settingsModal}>
            <div className="flyer-box bg-card p-4 space-y-4 mt-12">
              ...
              <button
                ...
                {...hotkey('escape', { title: t('Shortcut: Esc', 'Atalho: Esc') })}
              >
                {withShortcut(isLeaving ? t('Leaving...', 'A sair...') : t('Leave Lobby', 'Sair do lobby'), `(${ESC_LABEL})`)}
              </button>
            </div>
          </StageBackground>
        </>
                ...
                <div>
                  ...
                  <div className="mt-1 inline-flex items-center gap-3 rounded-md border-2 border-blue-deep bg-blue-light/40 px-4 py-2 font-mono text-3xl font-black tracking-[0.3em] shadow-flyer-sm">
                    ...
                    <button
                      ...
                      {...hotkey('c', { title: t('Shortcut: C', 'Atalho: C') })}
                    >
